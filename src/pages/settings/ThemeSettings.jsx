    ...
    <div>
      <div className="bg-white rounded-2xl p-8 shadow-md relative space-y-8">
        <div>
          ...
          <button
            onClick={saveLogos}
            className="mt-4 px-6 py-3 bg-[#434242] text-white rounded-xl hover:bg-black transition w-full md:w-75"
          >
            Save Logos
          </button>
        </div>
            ...
            <button
              onClick={() =>
                Swal.fire({
                  ...
                  confirmButtonColor: "#434242",
                  cancelButtonColor: "#d33",
                }).then((result) => {
                  if (result.isConfirmed) restoreTheme();
                })
              }
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#434242] hover:bg-[#0d0f18] text-white transition w-full md:w-75"
            >
          ...
          {(hasChanges || !themeId) && (
            <div className="mt-10 flex justify-between">
              ...
              <button
                ...
                className="px-8 py-3 bg-[#434242] text-white rounded-xl shadow-md hover:bg-black active:scale-95 transition disabled:opacity-50 flex items-center gap-2"
              >
