              ...
              <Tab as={Fragment} key={k}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected
                        ? `whitespace-nowrap bg-[#434242] focus-visible:outline-none border-b-2 border-darkBlue lg:border-0 dark:border-white dark:lg:border-0 text-white transition-all px-4 ${selectedClass}`
                        : unSelectedClass
                        ? unSelectedClass
